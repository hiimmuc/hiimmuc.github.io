...
**Awesome Source Latex CV** is based on a CV template created by Alessandro Plasmati. The original template uses the _XeLaTeX_ engine and the _[Fontin Sans](http://www.exljbris.com/fontinsans.html)_ font. 
...
You can edit online **Awesome Source Latex CV** on [Overleaf](https://www.overleaf.com/latex/templates/awesome-source-cv/wrdjtkkytqcw). Feel free to use my [referral link](https://www.overleaf.com/signup?ref=54c221604cd6) if you want to create your account.
...
Most social networks have their own command to render a clickable link or a simple text entry.

```latex
% Render author's LinkedIn (optional)
...
Put these commands in the `\socialinfo` wrapper. Feel free to add `\\` when you want to force a new line.
...
To describe your experiences, you first have to declare the `experiences` environment

```latex
% Begin a new experience environment to use the experience and consultant experience macro
\begin{experiences}

% Here's your experiences
...
% The consultant experience macro is very similar to the experience macro, but offers you 
% the possibility to put client details
...
Latex class file _awesome-source-cv.cls_ is published under the terms of the [LPPL Version 1.3c](https://www.latex-project.org/lppl.txt).
